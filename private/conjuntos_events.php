...
//DEL  function th_grupos1_ite_id_BeforeShow(& $sender)
//DEL  {
//DEL      $th_grupos1_ite_id_BeforeShow = true;
...
//DEL  // -------------------------
//DEL       $ite_id =  $th_grupos1->ite_id->GetValue();
//DEL  	 //$th_grupos1->ite_id->SetValue(CCDLookUp("ite_nombre", "tb_items", "ite_id=$ite_id", $DBsiges)); 
//DEL  // -------------------------

//DEL  function th_grupos1_ite_id1_BeforeShow(& $sender)
//DEL  {
//DEL      $th_grupos1_ite_id1_BeforeShow = true;
//DEL      $Component =  $sender;
//DEL      $Container =  CCGetParentContainer($sender);
//DEL      global $th_grupos1, $DBsiges; //Compatibility
...
//DEL  // -------------------------
//DEL       $ite_id =  $th_grupos1->ite_id1->GetValue();
//DEL  	 $th_grupos1->ite_id1->SetValue(CCDLookUp("ite_nombre", "tb_items", "ite_id=$ite_id", $DBsiges)); 
//DEL      
//DEL  // -------------------------
