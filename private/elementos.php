<?php
//Include Common Files @1-61542416
define("RelativePath", ".");
define("PathToCurrentPage", "/");
define("FileName", "elementos.php");
...
class clsRecordtb_itemsSearch { //tb_itemsSearch Class @3-568F13C2
...
//Class_Initialize Event @3-918BEA59
    function clsRecordtb_itemsSearch($RelativePath, & $Parent)
    {
        ...
        $this->ErrorBlock = "Record tb_itemsSearch/Error";
        ...
        if($this->Visible)
        {
            ...
            $this->s_ite_id->ds =  $this->s_ite_id->DataSource;
            $this->s_ite_id->DataSource->SQL = "SELECT *  " .
"FROM tb_items {SQL_Where} {SQL_OrderBy}";
            $this->s_ite_id->DataSource->wp = new clsSQLParameters();
...
//Validate Method @3-77DB570F
    function Validate()
    {
        global $CCSLocales;
        $Validation = true;
        $Where = "";
        $Validation = ($this->s_ite_nombre->Validate() && $Validation);
        $Validation = ($this->s_ite_id->Validate() && $Validation);
        $this->CCSEventResult = CCGetEvent($this->CCSEvents, "OnValidate", $this);
        $Validation =  $Validation && ($this->s_ite_nombre->Errors->Count() == 0);
        $Validation =  $Validation && ($this->s_ite_id->Errors->Count() == 0);
        return (($this->Errors->Count() == 0) && $Validation);
    }
//End Validate Method

//CheckErrors Method @3-28A1C83A
    function CheckErrors()
    {
        $errors = false;
        $errors = ($errors || $this->s_ite_nombre->Errors->Count());
        $errors = ($errors || $this->s_ite_id->Errors->Count());
...
//Operation Method @3-D09F84C9
    function Operation()
    {
        ...
        $Redirect = "elementos.php";
        if($this->Validate()) {
            if($this->PressedButton == "Button_DoSearch") {
                $Redirect = "elementos.php" . "?" . CCMergeQueryStrings(CCGetQueryString("Form", array("Button_DoSearch", "Button_DoSearch_x", "Button_DoSearch_y")));
...
//Show Method @3-77876950
    function Show()
    {
        ...
        if($this->FormSubmitted || $this->CheckErrors()) {
            $Error = "";
            $Error = ComposeStrings($Error, $this->s_ite_nombre->Errors->ToString());
            $Error = ComposeStrings($Error, $this->s_ite_id->Errors->ToString());
...
} //End tb_itemsSearch Class @3-FCB6E20C
...
//Class_Initialize Event @2-359ADE24
...
//Show Method @2-31A9740B
    function Show()
    {
        ...
        $this->DataSource->Parameters["urls_ite_id"] = CCGetFromGet("s_ite_id", "");
...
//SetOrder Method @2-6BF58FEB
    function SetOrder($SorterName, $SorterDirection)
    {
        $this->Order = "ite_id_itemSuperior, ite_orden";
...
//Prepare Method @2-BDF759AE
    function Prepare()
    {
        ...
        $this->wp->AddParameter("3", "urls_ite_id", ccsInteger, "", "", $this->Parameters["urls_ite_id"], "", false);
        $this->wp->AddParameter("4", "urls_ite_id", ccsInteger, "", "", $this->Parameters["urls_ite_id"], "", false);
        ...
        $this->wp->Criterion[2] = "ite_apl=1";
        $this->wp->Criterion[3] = $this->wp->Operation(opEqual, "ite_id_itemSuperior", $this->wp->GetDBValue("3"), $this->ToSQL($this->wp->GetDBValue("3"), ccsInteger),false);
        $this->wp->Criterion[4] = $this->wp->Operation(opEqual, "ite_id", $this->wp->GetDBValue("4"), $this->ToSQL($this->wp->GetDBValue("4"), ccsInteger),false);
...
//Class_Initialize Event @31-68BB0C79
...
"FROM tb_items {SQL_Where} {SQL_OrderBy}";
            ...
            $this->ite_id_itemSuperior->DataSource->wp->Criterion[2] = "ite_apl=1";
...
//Operation Method @31-0A960517
    function Operation()
    {
        ...
        $Redirect = "elementos.php" . "?" . CCGetQueryString("QueryString", array("ccsForm"));
...
$FileName = FileName;
$Redirect = "";
$TemplateFileName = "elementos.html";
$BlockToParse = "main";
...
//Include events file @1-0793D592
include("./elementos_events.php");
//End Include events file

//Initialize Objects @1-3434BFE6
...
//Execute Components @1-7B9CD044
$tb_itemsSearch->Operation();
$tb_items1->Operation();
//End Execute Components

//Go to destination page @1-938BD913
if($Redirect)
{
    $CCSEventResult = CCGetEvent($CCSEvents, "BeforeUnload", $MainPage);
    $DBsiges->close();
    header("Location: " . $Redirect);
    unset($tb_itemsSearch);
    unset($tb_items);
    unset($tb_items1);
    unset($Tpl);
    exit;
